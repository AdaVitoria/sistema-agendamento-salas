        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
              Plataforma completa para gestão e agendamento de salas de reunião
              com controle de acesso baseado em cargos e aprovações hierárquicas
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-16">
            <div className="p-6 rounded-lg border border-border bg-card hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground text-pretty">
                Agende salas com validação automática de conflitos, regras de
                acesso e limites por cargo
              </p>
            </div>
            ...
            <div className="p-6 rounded-lg border border-border bg-card hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground text-pretty">
                Sistema de aprovação baseado em cargo: Funcionário → Gerente →
                Diretor
              </p>
            </div>
            ...
            <div className="p-6 rounded-lg border border-border bg-card hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground text-pretty">
                Painel administrativo para gerenciar salas, usuários e
